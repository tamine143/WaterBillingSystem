...
<script src="jquery/bootstrap.min.js"></script>
      ...
      <table class="table table-bordered table-hover table-striped" >
      	...
      	<?php
      		while($penalty=mysqli_fetch_assoc($records)){
      			echo "<tr>";?>
						<td><?php echo $penalty['penalty'] ?></td>
						<td>
							<a href="edit_penalty.php?edit_account=<?php echo $penalty['Account_no']; ?>"><i class="fas fa-user-edit    "></i></a>
						</td>
					</tr>
      	<?php	}
      	?>
